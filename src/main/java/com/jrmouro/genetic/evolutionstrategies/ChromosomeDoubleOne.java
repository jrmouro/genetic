...
public class ChromosomeDoubleOne extends ChromosomeSD{
    ...
    public ChromosomeDoubleOne(List<Double> representation, FitnessFunction fitnessFunction, double sd) throws InvalidRepresentationException {
        super(prepare(representation,sd), fitnessFunction, sd);
        
    }
    
    protected ChromosomeDoubleOne(double sd, List<Double> representation, FitnessFunction fitnessFunction) throws InvalidRepresentationException {
        super(representation, fitnessFunction, sd);
        
    }

    public ChromosomeDoubleOne(Double[] representation, FitnessFunction fitnessFunction, double sd) throws InvalidRepresentationException {
        super(prepare(representation,sd), fitnessFunction, sd);
    ...
    public AbstractListChromosome<Double> newFixedLengthChromosome(List<Double> chromosomeRepresentation) {
        return new ChromosomeDoubleOne(chromosomeRepresentation, this.getFitnessFunction(), this.getSd());
    }
    ...
    public ChromosomeDouble evolve(boolean max) {
        ...
        ChromosomeDouble child = new ChromosomeDoubleOne(sd, representation, this.getFitnessFunction());
