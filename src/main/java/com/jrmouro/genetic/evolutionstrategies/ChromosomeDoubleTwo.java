...
public class ChromosomeDoubleTwo extends ChromosomeSD {
    ...
    public AbstractListChromosome<Double> newFixedLengthChromosome(List<Double> chromosomeRepresentation) {
        return new ChromosomeDoubleTwo(chromosomeRepresentation, this.getFitnessFunction(), this.getSd(), this.getValidityRepresentation());
    }
    ...
    public ChromosomeDouble evolve(boolean max) {
        ...
        ChromosomeDouble child = new ChromosomeDoubleTwo(sd, representation, this.getFitnessFunction(), this.getValidityRepresentation());
