...
public class ChromosomeOne extends ChromosomeSD {
    ...
    public AbstractListChromosome<Double> newFixedLengthChromosome(List<Double> chromosomeRepresentation) {
        return new ChromosomeOne(chromosomeRepresentation, this.getFitnessFunction(), this.getSd(), this.getValidityRepresentation());
    }

    @Override
    public List<Double> getGenotype() {
        List<Double> ret = super.getGenotype();
    ...
    public int getGenotypeSize() {
        return super.getGenotypeSize() - 1; //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public ChromosomeAbstract<Double> normalize() {
        ...
        return new ChromosomeOne(list, this.getFitnessFunction(), this.sd, this.getValidityRepresentation());
